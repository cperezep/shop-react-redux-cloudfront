...
import type { AvailableProduct } from '~/models/Product';

export const handlers = [
  rest.get(`${API_PATHS.product}/products`, (_req, res, ctx) => {
  ...
  rest.put(`${API_PATHS.product}/products/:id`, (_req, res, ctx) => {
    return res(ctx.status(200));
  }),
  rest.delete(`${API_PATHS.product}/products/:id`, (_req, res, ctx) => {
    return res(ctx.status(200));
  }),
